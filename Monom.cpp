...
Monom::Monom(int grad, float coef)
{
    ...
    {
        std::cout << "Coeficientul unui monom trebuie sa fie nenul!\n";
        exit(EXIT_FAILURE);
    }
}
...
Monom Monom::operator+(const Monom& other) const
{
    ...
    catch(Degrees_differ_mon& ddm)
    {
        std::cout << "Grade diferite la adunarea monoamelor!\n";
        exit(EXIT_FAILURE);
    }
}
Monom Monom::operator-(const Monom& other) const
{
    ...
    {
        std::cout << "Grade diferite la scaderea monoamelor!\n";
        exit(EXIT_FAILURE);
    }
}
Monom Monom::operator*(const Monom& other) const
...
Monom Monom::operator/(const Monom& other) const
{
    ...
    {
        std::cout << "Nu se poate imparti cu un monom nul!\n";
        exit(EXIT_FAILURE);
    }
    catch(Degree_too_small)
    {
        std::cout << "Nu se poate imparti un monom la alt monom cu un grad mai mare!\n";
        exit(EXIT_FAILURE);
    }
